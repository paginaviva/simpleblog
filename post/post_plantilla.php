...
$og_image = SITE_URL . "/assets/img/REEMPLAZAR_CON_OG_IMAGE";  // De [HEAD] OgImage (ajustar ruta)
$og_url = SITE_URL . "/post/REEMPLAZAR_CON_NOMBRE_ARCHIVO_HTML";  // De UrlPublica o NombreArchivoHTML
...
$twitter_image = SITE_URL . "/assets/img/REEMPLAZAR_CON_OG_IMAGE";  // De [HEAD] TwitterImage (ajustar ruta)
...
$masthead_bg = SITE_URL . "/assets/img/REEMPLAZAR_CON_IMAGEN_FONDO";  // De [CABECERA_VISUAL] ImagenFondo (ajustar ruta)
